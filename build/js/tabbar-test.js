const tabbar = () => {
    ...
    if(indicator.classList.contains('tabscontainer__tabs__tabindicatorhome')) {
        let tabIndicatorHome = document.querySelector(".tabscontainer__tabs__tabindicatorhome");
    } else {
        let tabIndicatorContact = document.querySelector(".tabscontainer__tabs__tabindicatorcontact");
    }
