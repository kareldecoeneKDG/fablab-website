        <footer class="footer">
            ...
            <section class="footer__content">
                ...
                <div class="footer__content__block">
                    <h4 class="footer__content__block__title footer-h4 first-title h4">Contact</h4>
                ...
                <!-- BLOCK -->
                <div class="footer__content__block">
                    <h4 class="footer__content__block__title footer-h4 h4">Openingsuren</h4>

                    <div class="footer__content__block__openhours">
                        <h5 class="footer__content__block__openhours__title footer-h5 h5">KdG-medewerkers/studenten</h5>
                        <p class="footer__content__block__openhours__paragraph">ma - do: 9.00u - 17.00u</p>
                    </div>

                    <div class="footer__content__block__openhours">
                        <h5 class="footer__content__block__openhours__title footer-h5 h5">Open lab momenten</h5>
                ...
                <!-- BLOCK -->
                <div class="footer__content__block">
                    <h4 class="footer__content__block__title footer-h4 h4">Met steun van</h4>
